...
export function Personal() {
  return (
    <defn
      ...
      class="text-red-500 cursor-help icon icon-personal"
    >
      #
    </defn>
  )
...
export function Professional() {
  return (
    <defn
      ...
      class="text-green-500 cursor-help icon icon-professional"
    >
      $
    </defn>
  )
...
export function Academic() {
  return (
    <defn
      ...
      class="text-purple-500 cursor-help icon icon-academic"
    >
      @
    </defn>
  )
...
export function Learning() {
  return (
    <defn
      title="Learning"
      class="text-yellow-500 cursor-help icon icon-learning"
    >
      §
    </defn>
  )
...
export function Interested() {
  return (
    <defn
      title="Interested in"
      class="text-cyan-500 cursor-help icon icon-interested"
    >
      ?
    </defn>
  )
...
export function OpenSource() {
  return (
    <defn
      title="Open Source"
      class="text-orange-400 cursor-help icon icon-open-source"
    >
      O
    </defn>
  )
